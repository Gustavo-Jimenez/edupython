#Start by defining the outline of the program, tomorrow continue. Check if Git works edit.
#Site: https://www.practicepython.org/exercise/2014/04/30/13-fibonacci.html
